...
<?=(isset($pagination_link)?$pagination_link:'')?>
  ...
  <p><?=anchor("basket/add/","<span>".$this->lang->line('add')."</span>",array('class'=>'btn-create'))?></p>
  <p><?=anchor("basket/archive/","<span>".$this->lang->line('archive')."</span>",array('class'=>'btn-create'))?></p>
  <p><?=anchor("basket/valuta/","<span>".$this->lang->line('valuta')."</span>",array('class'=>'btn-create'))?></p>
