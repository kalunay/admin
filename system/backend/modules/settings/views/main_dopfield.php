...
<form action="settings/adddopfield/copydellgroup" method="post" onsubmit="return confirm('<?=$this->lang->line('action_confirm')?>');">
...
<td class="t-center">
<?=anchor("settings/adddopfield/edit/".$i['id'],$this->lang->line('edit'),array('class'=>'ico-edit'))?> 
<?=anchor("settings/adddopfield/delete/".$i['id'],
...
<? endforeach; } ?>
  ...
  <p><?=anchor("settings/adddopfield/add/","<span>".$this->lang->line('adddopfield')."</span>",array('class'=>'btn-create'))?></p>
