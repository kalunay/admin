...
<form action="user/adddopfield/copydellgroup" method="post" onsubmit="return confirm('<?=$this->lang->line('action_confirm')?>');">
...
<td class="t-center">
<?=anchor("user/adddopfield/edit/".$i['id'],$this->lang->line('edit'),array('class'=>'ico-edit'))?> 
<?=anchor("user/adddopfield/delete/".$i['id'],
...
<? endforeach; } ?>
  ...
  <p><?=anchor("user/adddopfield/add/","<span>".$this->lang->line('adddopfield')."</span>",array('class'=>'btn-create'))?></p>
