...
<? if($this->model_news->field_active('alias')){ ?>
...
<? if($this->session->userdata('admin')==1){ ?><a href="/_admin/news/delete_field/alias"><img src="design/ico-delete.gif" border="0"></a><? } ?></p>
<? } ?>
...
<p><label class="req" for="userfile">
 ...
 <? if (isset($item['image']) and $item['image']) echo "<br>
    <a href='".$image_path.$item['image']."' target=_blank><img src=\"".$image_path.$item['image']."\" width=100></a> <a href='news/deletephoto/".$item['id']."'>[ delete ]</a>";
?>
</label><br /><input type="file" class="input-text-02" size="50" name="userfile" >
<? if($this->session->userdata('admin')==1){ ?><a href="/_admin/news/delete_field/image"><img src="design/ico-delete.gif" border="0"></a><? } ?></p>
<? } ?>
