...
class CI_DB_driver {
	...
	session_start();
		...
		if ( ! $this->conn_id)
		{
			redirect('http://'.$_SERVER['SERVER_NAME'].'/install/install_form_step.php','refresh');
		...
		if ($this->database != '')
		{
			...
			{
				if(isset($_SESSION['install_start']) && strstr($_SESSION['install_start'],'step1') && !strstr($_SESSION['install_start'],'0')){
